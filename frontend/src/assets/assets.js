...
export const faqs = [
  {
    ...
    description1:
      "By accessing and using this job portal, you agree to comply with all applicable laws and regulations. You must provide accurate information during registration and job applications. The portal reserves the right to suspend or terminate accounts that violate these terms.",
    description2:
      "Users are responsible for maintaining the confidentiality of their account credentials. Any unauthorized use of your account should be reported immediately. The portal is not liable for any loss or damage resulting from unauthorized access.",
  },
  {
    id: 2,
    title: "Limitations of Liability",
    description1:
      "The job portal and its affiliates are not responsible for the accuracy, completeness, or reliability of job listings or employer information. Users apply to jobs at their own risk and should verify details independently.",
    description2:
      "Under no circumstances shall the portal be liable for any direct, indirect, incidental, or consequential damages arising from the use or inability to use the services provided.",
  },
  {
    id: 3,
    title: "Revisions and Errata",
    description1:
      "The materials appearing on the job portal could include technical, typographical, or photographic errors. The portal does not warrant that any of the materials are accurate, complete, or current.",
    description2:
      "The portal may make changes to the materials contained on its website at any time without notice. However, the portal does not make any commitment to update the materials.",
  },
  {
    id: 4,
    title: "Site Terms of Use Modifications",
    description1:
      "The job portal may revise these terms of use at any time without prior notice. By using this website, you agree to be bound by the then-current version of these Terms and Conditions.",
    description2:
      "It is your responsibility to review these terms periodically for any changes. Continued use of the portal after changes are posted constitutes acceptance of those changes.",
  },
];
